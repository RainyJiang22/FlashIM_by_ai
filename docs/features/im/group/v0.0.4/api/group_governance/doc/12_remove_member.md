...
群主移除成员并向目标发送 membership_active=false。
...
```bash
/usr/bin/curl -sS -w '
%{http_code}' -X DELETE 'http://127.0.0.1:9600/groups/21c6fd90-fdc1-4368-aed0-82ea267d050f/members/2845' -H 'Authorization: Bearer <redacted>'
```
