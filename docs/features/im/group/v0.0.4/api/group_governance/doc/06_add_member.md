...
```bash
/usr/bin/curl -sS -w '
%{http_code}' -X POST 'http://127.0.0.1:9600/groups/21c6fd90-fdc1-4368-aed0-82ea267d050f/members' -H 'Authorization: Bearer <redacted>' -H 'Content-Type: application/json' -d '{"member_ids": [2846]}'
```
