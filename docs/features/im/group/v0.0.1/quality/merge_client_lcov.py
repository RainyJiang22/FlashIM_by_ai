...
OUTPUT = ROOT / "docs/features/im/group/v0.0.1/quality/client-attempt-1/lcov.info"
INPUTS = (
    (ROOT / "client/modules/flash_im_conversation/coverage/lcov.info", "client/modules/flash_im_conversation"),
    (ROOT / "client/modules/flash_im_group/coverage/lcov.info", "client/modules/flash_im_group"),
    (ROOT / "client/modules/flash_im_chat/coverage/lcov.info", "client/modules/flash_im_chat"),
